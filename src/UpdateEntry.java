...
public class UpdateEntry extends JInternalFrame {
    ...
    public UpdateEntry(String busNo, String regNo, String model, String capacity,
        ...
        btnUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    int result = stat.executeUpdate(temp);
                    setVisible(false);
                        dispose();
   ...
   /* public static void main(String args[])
    {
        ...
        UpdateEntry frm = new UpdateEntry("1200","12005","swift","55","2013-11-17","yes","2013-11-17","2013-11-29");
        jf.add(frm);
        jf.setVisible(true);
        frm.setVisible(true);
