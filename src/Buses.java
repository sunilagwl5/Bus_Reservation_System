...
public class Buses extends JPanel implements Printable {
    ...
    public Buses() {
        ...
        btnUpdate.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                UpdateEntry frm = new UpdateEntry(tblBusList.getValueAt(getSelectedRow(), 0).toString(),
                tblBusList.getValueAt(getSelectedRow(), 1).toString(),
                tblBusList.getValueAt(getSelectedRow(), 2).toString(),
                tblBusList.getValueAt(getSelectedRow(), 3).toString(),
                tblBusList.getValueAt(getSelectedRow(), 4).toString(),
                tblBusList.getValueAt(getSelectedRow(), 5).toString(),
                tblBusList.getValueAt(getSelectedRow(), 6).toString(),
                tblBusList.getValueAt(getSelectedRow(), 7).toString());
                MDIWindow.desktop.add(frm);
                frm.setVisible(true);
            }
        });
    ...
    class AbstractTable extends AbstractTableModel {
        ...
        private String[] columnNames = {"BusNo", "RegNo", "Model", "Capacity",
